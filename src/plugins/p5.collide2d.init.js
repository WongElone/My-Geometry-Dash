...
CC BY-NC-SA 4.0
*/
function p5Collide2dInit(p5) {

console.log("### p5.collide v0.7.3 ###")

p5._collideDebug = false;

p5.collideDebug = function(debugMode){
    p5._collideDebug = debugMode;
}

/*~++~+~+~++~+~++~++~+~+~ 2D ~+~+~++~+~++~+~+~+~+~+~+~+~+~+~+*/

p5.collideRectRect = function (x, y, w, h, x2, y2, w2, h2) {
  //2d
...
p5.collideRectRectVector = function(p1, sz, p2, sz2){
  return p5.collideRectRect(p1.x, p1.y, sz.x, sz.y, p2.x, p2.y, sz2.x,sz2.y)
}


p5.collideRectCircle = function (rx, ry, rw, rh, cx, cy, diameter) {
  //2d
...
p5.collideRectCircleVector = function(r, sz, c, diameter){
  return p5.collideRectCircle(r.x,r.y, sz.x,sz.y, c.x,c.y, diameter)
}

p5.collideCircleCircle = function (x, y,d, x2, y2, d2) {
//2d
...
p5.collideCircleCircleVector = function(p1,d, p2, d2){
  return p5.collideCircleCircle(p1.x,p1.y,  d, p2.x,p2.y, d2)
}
...
p5.collidePointCircleVector = function(p, c, d){
  return p5.collidePointCircle(p.x,p.y,c.x,c.y,  d)
}

p5.collidePointEllipse = function (x, y, cx, cy, dx, dy) {
  //2d
  var rx = dx/2, ry = dy/2;
...
p5.collidePointEllipseVector = function(p, c, d){
  return p5.collidePointEllipse(p.x,p.y,c.x,c.y,d.x,d.y);
}
...
p5.collidePointRectVector = function(point, p1, sz){
  return p5.collidePointRect(point.x, point.y, p1.x, p1.y, sz.x, sz.y);
}

p5.collidePointLine = function(px,py,x1,y1,x2,y2, buffer){
...
p5.collidePointLineVector = function(point,p1,p2, buffer){
  return p5.collidePointLine(point.x,point.y, p1.x,p1.y, p2.x,p2.y, buffer);
}

p5.collideLineCircle = function( x1,  y1,  x2,  y2,  cx,  cy,  diameter) {
...
p5.collideLineCircleVector = function( p1,  p2,  c,  diameter){
  return p5.collideLineCircle( p1.x,  p1.y,  p2.x,  p2.y,  c.x,  c.y,  diameter);
}
p5.collideLineLine = function(x1, y1, x2, y2, x3, y3, x4, y4,calcIntersection) {
...
p5.collideLineLineVector = function(p1, p2, p3, p4, calcIntersection){
  return p5.collideLineLine(p1.x, p1.y, p2.x, p2.y, p3.x, p3.y, p4.x, p4.y, calcIntersection);
}

p5.collideLineRect = function(x1, y1, x2, y2, rx, ry, rw, rh, calcIntersection) {
...
p5.collideLineRectVector = function(p1, p2, r, rsz, calcIntersection){
  return p5.collideLineRect(p1.x, p1.y, p2.x, p2.y, r.x, r.y, rsz.x, rsz.y, calcIntersection);
}

p5.collidePointPoly = function(px, py, vertices) {
  var collision = false;
...
p5.collidePointPolyVector = function(p1, vertices){
  return p5.collidePointPoly(p1.x, p1.y, vertices);
}

// POLYGON/CIRCLE
p5.collideCirclePoly = function(cx, cy, diameter, vertices, interior) {
...
p5.collideCirclePolyVector = function(c, diameter, vertices, interior){
  return p5.collideCirclePoly(c.x, c.y, diameter, vertices, interior);
}

p5.collideRectPoly = function( rx, ry, rw, rh, vertices, interior) {
  if (interior == undefined){
    interior = false;
  }
...
p5.collideRectPolyVector = function(r, rsz, vertices, interior){
  return p5.collideRectPoly(r.x, r.y, rsz.x, rsz.y, vertices, interior);
}

p5.collideLinePoly = function(x1, y1, x2, y2, vertices) {
...
p5.collideLinePolyVector = function(p1, p2, vertice){
  return p5.collideLinePoly(p1.x, p1.y, p2.x, p2.y, vertice);
}

p5.collidePolyPoly = function(p1, p2, interior) {
  if (interior === undefined){
    interior = false;
  }
...
p5.collidePolyPolyVector = function(p1, p2, interior) {
  return p5.collidePolyPoly(p1, p2, interior);
}

p5.collidePointTriangle = function(px, py, x1, y1, x2, y2, x3, y3) {
...
p5.collidePointTriangleVector = function(p, p1, p2, p3){
  return p5.collidePointTriangle(p.x, p.y, p1.x, p1.y, p2.x, p2.y, p3.x, p3.y);
}

p5.collidePointPoint = function (x,y,x2,y2, buffer) {
    if(buffer === undefined){
      buffer = 0;
    }
...
p5.collidePointPointVector = function(p1, p2, buffer){
  return p5.collidePointPoint(p1.x,p1.y,p2.x,p2.y, buffer);
}

p5.collidePointArc = function(px, py, ax, ay, arcRadius, arcHeading, arcAngle, buffer) {
...
p5.collidePointArcVector = function(p1, a, arcRadius, arcHeading, arcAngle, buffer){
  return p5.collidePointArc(p1.x, p1.y, a.x, a.y, arcRadius, arcHeading, arcAngle, buffer);
}

}

export default p5Collide2dInit;
// module.exports.p5Collide2d = p5;