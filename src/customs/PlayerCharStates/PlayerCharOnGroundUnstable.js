  ...
  getNextFramePChar(FRAME_DURATION) {
    ...
    if (nextPChar.vY === 0) {
      ...
      if (angleOfElevation < Math.PI / 3) {
        ...
        nextPChar.rad =
          angularDisplace > angleOfElevation
            ? 0
            : nextPChar.rad + angularDisplace;
        ...
        nextPChar.rad =
          angularDisplace > Math.PI * 0.5 - angleOfElevation
            ? 0
            : nextPChar.rad + angularDisplace;
        // keep contact corner continuous contact
        nextPChar.y += oldContactVertice[1] - nextPChar.getLowestVertice()[1];
      ...
      nextPChar.x +=
        nextPChar.vX * FRAME_DURATION +
        0.5 * nextPChar.aX * FRAME_DURATION ** 2;
      ...
      nextPChar.vX += nextPChar.aX * FRAME_DURATION;
      nextPChar.y +=
        nextPChar.vY * FRAME_DURATION +
        0.5 * nextPChar.aY * FRAME_DURATION ** 2;
